...
Array may not stay empty and object do always need to include the same amount of keys.
You can provide default schemas via the prop `schemas`. It is an object with
